...
void clockInit(void) {
    ...
    // Set DCO to run at 16MHz
    CS_setDCOFreq(
            CS_DCORSEL_1,                                                       // Set Frequency range (DCOR)
            CS_DCOFSEL_4                                                        // Set Frequency (DCOF)
    );
    ...
    // Set SMCLK to use DCO as its oscillator source (DCO was configured earlier in this function for 16MHz)
    CS_initClockSignal(
    ...
    // Set MCLK to use DCO as its oscillator source (DCO was configured earlier in this function for 16MHz)
    CS_initClockSignal(
