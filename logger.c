...
void push_data(int sign,int k, int l,int m,int n){
    ...
    FileTextE104[16 + log_counter*11] = sign;
    FileTextE104[17 + log_counter*11] = k+48;
    FileTextE104[18 + log_counter*11] = l+48;
    FileTextE104[19 + log_counter*11] = m+48;
    FileTextE104[20 + log_counter*11] = n+48;
