...
//
//
//void data_buffer(unsigned int thermistor_temperature, unsigned int Temperature){
///////////////filling the temperature/////////////////////////
//	unsigned int temp;
//	temp = thermistor_temperature;
//
//#ifdef DEBUG
//			char str[30];
//			sprintf(str, "\n\rTemperature: %d ", Temperature);
...
//#endif
//
//	temp = thermistor_temperature % 10000;
//	temp = temp / 1000;			//buffer hold 0 has character t
//	bufferHold[1] = (char) temp + 48;
//	temp = thermistor_temperature % 1000;
//
//	temp = temp / 100;
//	bufferHold[2] = (char) temp + 48;
//	temp = thermistor_temperature % 100;
//
//	temp = temp / 10;
//	bufferHold[4] = (char) temp + 48;
//	temp = thermistor_temperature % 10;
//
//	bufferHold[5] = (char) temp + 48;
//	//////////////////////////////////////////////////////////////
//
...
//	timestamp = getTimeStamp();
//
//	bufferHold[14] = timestamp.hour[1];
//	bufferHold[15] = timestamp.hour[0];
//
//	bufferHold[17] = timestamp.minute[1];
//	bufferHold[18] = timestamp.minute[0];
//
//	bufferHold[20] = '2';
//	bufferHold[21] = '0';
//	bufferHold[22] = timestamp.year[1];
//	bufferHold[23] = timestamp.year[0];
//
//	bufferHold[25] = timestamp.month[1];
//	bufferHold[26] = timestamp.month[0];
//
//	bufferHold[28]  = timestamp.day[1];
//	bufferHold[29] = timestamp.day[0];
//
//
//#ifdef DEBUG
//	myuart_tx_byte(timestamp.hour[1]);
